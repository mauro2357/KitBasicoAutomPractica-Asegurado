...
public class AfiliadoFacadeTestConStub {
	...
	public void crearAfiliadoMayor18Anios() {
		Afiliado afiliado=new Afiliado("1231232", "Pedro", "Perez", "123123123", 19, 10000, 0);
	...
	public void noCrearAfiliadoMenor18Anios() {
		Afiliado afiliado=new Afiliado("1231232", "Pedro", "Perez", "123123123", 15, 10000, 0);
		Mockito.when(afiliadosRepositorio.save(afiliado)).thenReturn(afiliado);
		assertFalse("Afiliado no creado", afiliadosFacade.afiliar(afiliado)!=null);
	}
	
	@Test
	public void crearAfiliadoMayorSalarioCienMil() {
		Afiliado afiliado=new Afiliado("1231232", "Pedro", "Perez", "123123123", 19, 1000001, 0);
		Mockito.when(afiliadosRepositorio.save(afiliado)).thenReturn(afiliado);
	...
	@Test
	public void noCrearAfiliadoMEnorCienMil() {
	...
	@Test
	public void crearAfiliadoViveLima() {
		Afiliado afiliado=new Afiliado("1231232", "Pedro", "Perez", "123123123", 19, 1000001, 1);
		Mockito.when(afiliadosRepositorio.save(afiliado)).thenReturn(afiliado);
	...
	@Test
	public void noCrearAfiliadoViveLima() {
		Afiliado afiliado=new Afiliado("1231232", "Pedro", "Perez", "123123123", 15, 1000, 0);
		Mockito.when(afiliadosRepositorio.save(afiliado)).thenReturn(afiliado);
		assertFalse("Afiliado no creado", afiliadosFacade.afiliar(afiliado)!=null);
	}*/
